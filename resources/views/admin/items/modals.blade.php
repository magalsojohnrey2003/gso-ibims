...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('office-add-btn')?.addEventListener('click', async () => {
    ...
    try {
      ...
      showToast('success', 'Office code saved successfully');
    } catch (err) {
      showToast('error', err.message || 'Failed to save office code');
    }
  });
  ...
  officeListBody?.addEventListener('click', async (ev) => {
    ...
    try {
      ...
      await fetchOfficesFromServer();
      showToast('success', 'Office code deleted successfully');
    } catch (err) {
      showToast('error', err.message || 'Failed to delete office code');
    }
  });
