...
<tr data-user-id="{{ $user->id }}">
    <td class="px-6 py-4 whitespace-nowrap max-w-xs truncate" title="{{ $user->full_name ?? ($user->first_name . ' ' . $user->last_name) }}">{{ $user->full_name ?? ($user->first_name . ' ' . $user->last_name) }}</td>
