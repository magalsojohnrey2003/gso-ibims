<nav x-data="{ open: false }"
    ...
    <div class="hidden sm:flex sm:items-center relative space-x-6">
        ...
        <div class="relative flex items-center">
            <button id="notificationBtn" class="relative w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition mr-1" aria-haspopup="true" aria-expanded="false" aria-controls="notificationDropdown">
                <i class="fas fa-bell text-lg text-gray-700 dark:text-gray-300" aria-hidden="true"></i>
                <span id="notificationBadge" class="absolute -top-1 -right-1 inline-flex items-center justify-center rounded-full text-xs w-5 h-5 bg-red-600 text-white hidden">0</span>
            </button>
        ...
        <div class="relative">
            <button id="profileDropdownBtn" class="flex items-center focus:outline-none" aria-haspopup="true" aria-expanded="false" aria-controls="profileDropdown">
                <div class="w-9 h-9 rounded-full overflow-hidden
                    border-2 transition shadow-md
                    theme-light:border-blue-500 theme-light:shadow-blue-500/60
                    theme-dark:border-cyan-400 theme-dark:shadow-cyan-400/70
