<aside id="sidebar"
    class="w-64 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-lg h-screen transition-all duration-300 
           transform -translate-x-full lg:translate-x-0 lg:relative flex-shrink-0 
    ...
    <nav class="mt-6">
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ auth()->user()->role === 'admin' ? route('admin.dashboard') : route('user.dashboard') }}"
                   class="flex items-center px-4 py-3 rounded-md transition 
