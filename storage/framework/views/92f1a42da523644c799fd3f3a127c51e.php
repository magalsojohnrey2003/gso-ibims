                          ...
                          <tr class="hover:bg-gray-50 text-center" data-item-row="<?php echo e($item->id); ?>">
                              <td class="px-6 py-4" data-item-photo>
                                  ...
                                  <div class="flex justify-center">
                                      <img src="<?php echo e($photoUrl); ?>" data-item-photo-img class="h-12 w-12 object-cover rounded-lg shadow-sm" alt="<?php echo e($item->name); ?>">
                                  </div>
                              </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'primary','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow-lg [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'pencil-square','xData' => true,'xOn:click.prevent' => '$dispatch(\'open-modal\', \'edit-item-'.e($item->id).'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow-lg [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'pencil-square','x-data' => true,'x-on:click.prevent' => '$dispatch(\'open-modal\', \'edit-item-'.e($item->id).'\')']); ?>
                                          Edit
                                       <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                      <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'secondary','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'eye','xData' => true,'xOn:click.prevent' => '$dispatch(\'open-modal\', \'view-item-'.e($item->id).'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'eye','x-data' => true,'x-on:click.prevent' => '$dispatch(\'open-modal\', \'view-item-'.e($item->id).'\')']); ?>
                                          View
                                       <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'printer','type' => 'button','data-print-stickers' => true,'data-print-route' => ''.e(route('admin.items.stickers', $item)).'','data-print-default' => ''.e(max(1, min(5, $item->instances->count()))).'','data-print-quantity' => ''.e(max(1, $item->instances->count())).'','data-print-item' => ''.e($item->name).'','data-print-description' => ''.e($item->description).'','data-print-acquisition' => ''.e(optional($item->acquisition_date)->format('m/d/Y')).'','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->instances->isEmpty())]); ?>
                                          Print
                                       <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
...
<?php endif; ?>
                                      <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'danger','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'trash','xData' => true,'xOn:click.prevent' => '$dispatch(\'open-modal\', \'confirm-delete-'.e($item->id).'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'danger','size' => 'sm','class' => 'h-10 w-10 !px-0 !py-0 rounded-full shadow [&>span:first-child]:mr-0 [&>span:last-child]:sr-only','iconName' => 'trash','x-data' => true,'x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-delete-'.e($item->id).'\')']); ?>
                                          Delete
                                       <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning','text' => 'No items found']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php echo app('Illuminate\Foundation\Vite')(['resources/js/app.js']); ?><?php /**PATH C:\Users\magal\Desktop\gso-ibims\resources\views/admin/items/index.blade.php ENDPATH**/ ?>