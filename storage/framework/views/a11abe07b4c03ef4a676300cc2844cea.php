...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('password.store')); ?>" class="mt-6 space-y-4">
        ...
        <input type="hidden" name="token" value="<?php echo e($request->route('token') ?? old('token')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'email','class' => 'block mt-1 w-full','type' => 'email','name' => 'email','value' => old('email', $request->email ?? ''),'required' => true,'autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\magal\Desktop\gso-ibims\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>