...
<?php $component->withAttributes([]); ?>
    <div class="flex flex-col items-center text-center">
        <img src="<?php echo e(asset('images/logo2.png')); ?>" alt="Logo" class="w-28 h-28 rounded-md mb-4">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-session-status','data' => ['class' => 'mt-4','status' => session('status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-4','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(session('status'))]); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between">
            <a href="<?php echo e(route('login')); ?>" class="text-sm text-purple-600 hover:underline">Back to login</a>
...
<?php endif; ?>
<?php /**PATH /home/u928333042/domains/gsoibims-tagoloan.com/public_html/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>