...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.title','data' => ['level' => 'h2','size' => '2xl','weight' => 'bold','icon' => 'archive-box-arrow-down','variant' => 's','iconStyle' => 'plain','iconColor' => 'title-purple']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['level' => 'h2','size' => '2xl','weight' => 'bold','icon' => 'archive-box-arrow-down','variant' => 's','iconStyle' => 'plain','iconColor' => 'title-purple']); ?>
                Borrow Items
