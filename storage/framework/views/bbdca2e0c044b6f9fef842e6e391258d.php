...
<?php endif; ?>
                                        <select id="location_municipality"
                                                ...
                                                data-initial="<?php echo e($oldMunicipalityKey ?? ''); ?>">
                                            <option value="" disabled selected>Select municipality</option>
                                            <?php $__currentLoopData = $municipalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $definition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                        data-label="<?php echo e($definition['label'] ?? $key); ?>"
                                                        <?php if(($oldMunicipalityKey ?? '') === $key): echo 'selected'; endif; ?>>
...
<?php endif; ?>
                                        <select id="location_barangay"
                                                class="mt-1 w-full rounded-md border border-gray-600 bg-white px-3 py-2 text-gray-800"
                                                data-initial="<?php echo e($oldBarangay ?? ''); ?>"
                                                disabled>
...
<?php endif; ?>
                                        <select id="location_purok"
                                                class="mt-1 w-full rounded-md border border-gray-600 bg-white px-3 py-2 text-gray-800"
                                                data-initial="<?php echo e($oldPurok ?? ''); ?>"
                                                disabled>
                                            <option value="">Select purok / zone / sitio</option>
                                        </select>
                                    </div>

                                    <div id="locationDisplayWrapper" class="<?php echo e($oldLocation ? '' : 'hidden'); ?>">
                                        <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
...
<?php endif; ?>
                                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'location_display','type' => 'text','class' => 'mt-1 w-full border border-gray-600 bg-gray-100 text-gray-800','readonly' => true,'value' => ''.e($oldLocation).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'location_display','type' => 'text','class' => 'mt-1 w-full border border-gray-600 bg-gray-100 text-gray-800','readonly' => true,'value' => ''.e($oldLocation).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                                    ...
                                    <input type="hidden" id="location" name="location" value="<?php echo e($oldLocation); ?>">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
    ...
    <script>
        window.LOCATION_ENDPOINTS = {
            barangays: "<?php echo e(route('user.locations.barangays')); ?>",
            puroks: "<?php echo e(route('user.locations.puroks')); ?>"
        };
    </script>
